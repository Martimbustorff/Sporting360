...
export function AppRoutes() {
  ...
  return (
    ...
    >
      <Stack.Screen
        name="Index"
        component={enterInApp ? Home : Index}
        options={{
          title: "Faça login",
        }}
      />
      ...
      <Stack.Screen
        name="Definitions"
        component={!user ? Login : Definitions}
        options={{
          animationEnabled: false,
        }}
      />
      ...
      <Stack.Screen
        name="GameboxMangementDefault"
        component={!user ? Login : GameboxMangementDefault}
        options={{
          animationEnabled: false,
        }}
      />
      ...
      <Stack.Screen
        name="DefinitionsMenu"
        component={!user ? Login : DefinitionsMenu}
        options={{
          animationEnabled: false,
        }}
      />
      ...
      <Stack.Screen
        name="GameboxMangement"
        component={!user ? Login : GameboxMangement}
        options={{
          animationEnabled: false,
        }}
      />
      ...
      <Stack.Screen
        name="GameboxList"
        component={!user ? Login : GameboxList}
        options={{
          animationEnabled: false,
        }}
      />
