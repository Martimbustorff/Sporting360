...
const GameboxCard = ({ gamebox, user, navigation }) => {
  if (gamebox === null) {
    return (
      <Text className="font-dinBold mt-2 text-black text-lg">
  ...
  return (
    <View className="flex flex-col">
      <View className="w-80 mr-2 justify-center mb-4 mt-4 items-center">
        ...
        <Text className="font-dinLight text-black text-lg">
        ...
        <View className="bg-whiteHomeGamebox w-full rounded-lg flex flex-row justify-between h-20 mt-4">
          <View className="flex flex-col justify-center items-center w-20">
            <Text className="font-dinBold text-black opacity-50 text-sm">
              PORTA
            </Text>
            <Text className="font-dinRegular text-black text-lg">
              {gamebox.gameboxPort ? gamebox.gameboxPort : "---"}
            </Text>
          </View>
          <View className="flex flex-col justify-center items-center w-20">
            <Text className="font-dinBold text-black opacity-50 text-sm">
            ...
            <Text className="font-dinRegular text-black text-lg">
              {gamebox.gameboxSector ? gamebox.gameboxSector : "---"}
            </Text>
          </View>
          <View className="flex flex-col justify-center items-center w-20">
            <Text className="font-dinBold text-black opacity-50 text-sm">
            ...
            <Text className="font-dinRegular text-black text-lg">
              {gamebox.gameboxLine ? gamebox.gameboxLine : "---"}
            </Text>
          </View>
          <View className="flex flex-col justify-center items-center w-20">
            <Text className="font-dinBold text-black opacity-50 text-sm">
            ...
            <Text className="font-dinRegular text-black text-lg">
              {gamebox.gameboxSeat ? gamebox.gameboxSeat : "---"}
            </Text>
          </View>
        </View>
