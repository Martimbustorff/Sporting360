      ...
      <Animated.View sharedTransitionTag="sharedTag" className="w-full h-44">
        ...
        <View className="w-full items-center flex-row mt-4 pl-4 justify-center pr-4">
          ...
          <View className="flex flex-col w-1/3  items-center gap-2">
            ...
            >
              <Text
                className={`font-dinBold  text-sm  text-white ${Platform.OS === "ios" && "leading-9 h-full pt-"}`}
              >
                J{jorney.trim()}
              </Text>
            </View>
            ...
            {!isStart && (
              <View className=" bg-white_20 p-1 w-16 mt-2 h-8 pl-1 pr-1 rounded-full justify-center items-center">
                <Text
