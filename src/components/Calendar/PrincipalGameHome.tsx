  ...
  return (
    ...
    >
      <Animated.View
        ...
        className="w-80 mt-12 self-center bg-bgauth opacity-70 rounded-lg h-44"
      >
        <View className="w-full bg-white_20 h-8 rounded-lg justify-center items-center">
          <Text
            className={`text-white font-dinBold ${Platform.OS === "ios" && "pt-2"}  text-lg `}
          >
            {competation}
          </Text>
        </View>
        <View className="w-full items-center flex-row mt-4  justify-center ">
          ...
          <View className="flex flex-col w-1/3  items-center gap-2">
            <View
              ...
              className=" justify-center mb-1 items-center rounded-full h-6 w-11"
            >
              <Text
                className={`font-dinBold  text-xs  text-white ${Platform.OS === "ios" && "leading-9 h-full pt-"}`}
              >
                J{jorney.trim()}
              </Text>
            </View>
              ...
              <View className=" justify-center mb-[-8]  items-center">
                ...
                <View className="w-20 flex-row mt-2  justify-between">
                  <View className="bg-white w-9 mr-2 h-10 rounded-md justify-center items-center">
                    <Text
                      className={`font-dinBold  text-lg  text-bgauth ${Platform.OS === "ios" && "leading-9  pt-2"}`}
                    >
            ...
            {!isStart && (
              <View className=" bg-white_20 p-1  w-16 mt-4 h-8 pl-1 pr-1 rounded-full justify-center items-center">
                <Text
                  className={`font-dinBold  text-xs  text-white ${Platform.OS === "ios" && "leading-9"}`}
                >
                  SportTV1
                </Text>
              </View>
