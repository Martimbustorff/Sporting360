...
const Gamebox = () => {
  ...
  const handleBarCodeScanned = async ({ type, data }) => {
    ...
    Popup.show({
      ...
      textBody:
        "Por favor, confirme se o número lido pela nossa aplicação está correto. Se estiver, prossiga para desfrutar das emoções do Sporting; caso contrário, verifique novamente",
