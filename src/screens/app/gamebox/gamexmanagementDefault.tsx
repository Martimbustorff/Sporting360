...
const GameboxMangementDefault = () => {
  ...
  const [gameboxNumber, setGameboxNumber] = useState(
    decryptGameBox(user?.gameboxNumber, user?.uuid),
  );
  ...
  return (
    ...
    >
      <SafeAreaView
        className={`bg-bgauth w-full  flex-1 h-full justify-start items-center`}
      >
        <Image
          className="flex flex-1  absolute h-full w-full"
          source={require("../../../assets/opacebg.png")}
        ...
        <View className={`mt-0  p-6   flex flex-1 w-full`}>
          <Animated.View
            ...
            className="flex flex-[0.8] w-full"
          >
            <View className="w-full flex  flex-row">
              {gameboxReaded.gameboxNumber ? (
                ...
                <Input
                  defaultValue={decryptGameBox(user.gameboxNumber, user.uuid)}
                  keyboardType="number-pad"
                  autoCapitalize="none"
                  handleGetValue={(value) => {
                    setGameboxNumber(value);
            ...
            <Input
              defaultValue={user.gameboxName ? user.gameboxName : "Principal"}
            ...
            />
            <Input
              defaultValue={user.gameboxSector}
              keyboardType="default"
              autoCapitalize="none"
              handleGetValue={(value) => {
