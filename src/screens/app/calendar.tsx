      ...
      >
        ...
        <View className="w-full pl-4 pr-4">
          <View className="w-full mt-3 flex-row justify-between   bg-white_20 rounded-md h-11">
            <TouchableOpacity
              onPress={() => {
                ...
                scrollViewRef.current?.scrollTo({
                  x: Dimensions.get("window").width * newIndex,
                  animated: true,
                });
              }}
            ...
            >
              <Text
                className={`text-white text-base ${index !== 0 && "opacity-50"} ${Platform.OS === "ios" && "pt-3"} font-dinRegular`}
              >
                Próximos
              </Text>
            </TouchableOpacity>
            ...
            >
              <Text
                className={`text-white text-base ${index !== 1 && "opacity-50"} ${Platform.OS === "ios" && "pt-3"} font-dinRegular`}
              >
                Resultados
              </Text>
            </TouchableOpacity>
          ...
          >
            <ScrollView
              contentContainerStyle={{
                paddingBottom: featureGames.length * 16,
