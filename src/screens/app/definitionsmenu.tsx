      ...
      <ScrollView>
        <Animated.View entering={FadeIn.delay(600)} className='flex  justify-end flex-col flex-1  gap-4'>
          <TouchableOpacity
            ...
            <View className='flex flex-row border-b-[0.5px] border-b-white pb-3  gap-2 justify-between items-center'>
              <View className='flex flex-row  justify-center pb-3 items-center'>
                <Image resizeMode="contain" className="h-6 w-4 mr-4 object-contain" source={require('../../assets/icons/userinfo.png')} />
                <Text className={`font-dinCondensed ${Platform.OS === 'ios' ? 'h-6 mt-4' : 'mt-0'} text-white text-lg`} >CONTA S360</Text>
              </View>
          ...
          <TouchableOpacity
            ...
            <View className='flex flex-row border-b-[0.5px] border-b-white pb-3  gap-2 justify-between items-center'>
              <View className='flex flex-row  justify-center pb-3 items-center'>
                <Image resizeMode="contain" className="h-6 w-4 mr-4 object-contain" source={require('../../assets/icons/qrcode.png')} />
                <Text className={`font-dinCondensed ${Platform.OS === 'ios' ? 'h-6 mt-4' : 'mt-0'} text-white text-lg`} >GESTÃO GAMEBOX</Text>
              </View>
              <Image source={require('../../assets/arrow.png')} className="top-1" />
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            <View className='flex flex-row border-b-[0.5px] border-b-white pb-3  gap-2 justify-between items-center'>
              <View className='flex flex-row  justify-center pb-3 items-center'>
                <Image resizeMode="contain" className="h-6 w-4 mr-4 object-contain" source={require('../../assets/icons/lock.png')} />
                <Text className={`font-dinCondensed ${Platform.OS === 'ios' ? 'h-6 mt-4' : 'mt-0'} text-white text-lg`} >DEFINIR PASSCODE</Text>
              </View>
              <Image source={require('../../assets/arrow.png')} className="top-1" />
            </View>
          </TouchableOpacity>
