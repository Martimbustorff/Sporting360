          ...
          return (
            ...
            >
              <View className="flex-[0.8]">
                <Image className="flex-[0.8] absolute" source={data.Image} />
              </View>
              <View
              ...
              >
                <Animated.View className=" flex-[0.6] gap-4 flex-col justify-start items-center">
                  <Animated.Text
      ...
      <View className="flex-[0.2] p-4 gap-3 flex flex-row">
        ...
        >
          <Text className="text-white font-dinMedium text-md">
            {actualIndex + 1 === onboardingData.length
              ? "FINALIZAR"
              : "SEGUINTE"}
          </Text>
        </TouchableOpacity>
