    ...
    <View className="h-full p-6 bg-bgauth  w-full">
      <SafeAreaView className="bg-bgauth  flex-1 justify-start items-center">
        ...
        <View className="mt-4 flex flex-1 w-full">
          ...
          >
            <Text
              className={`text-white ${Platform.OS === "ios" ? "leading-10" : ""} opacity-50 font-dinRegular text-center`}
            >
              Ao clicar em criar conta aceita os nossos {"\n"}
            </Text>
            <Text
              className={`text-white ${Platform.OS === "ios" ? "leading-10" : ""}  text-titleauth font-dinBold mt-[-14]  text-center`}
            >
              Termos e Condições
            </Text>
          </TouchableOpacity>
